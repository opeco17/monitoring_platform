...
class Config(object):
    ...
    METRICS_SEQUENCE_LENGTH = int(os.environ.get('METRICS_SEQUENCE_LENGTH'))
    ALLOWABLE_NUMBER_OF_FAILURES = int(os.environ.get('ALLOWABLE_NUMBER_OF_FAILURES'))
    THRESHOLD_RATE = float(os.environ.get('THRESHOLD_RATE'))
